# Lote 04 de Posts: Investimento Sistemático e Factor Investing Aplicado ao Brasil (B3)

**Autor:** Lucca Simeoni Pavan, Ph.D.  
**Objetivo:** Aquecimento de audiência e geração de autoridade institucional com ganchos diretos para os temas do curso *Análise Quantitativa Aplicada* e download do material institucional.  
**Status no Buffer:** 4 posts agendados na fila ativa e 1 post salvo em Drafts (teto máximo de 10 posts do plano Buffer atingido; liberação automática após os envios diários).

---

## Post 1: A Falácia do "Stock Picking" e a Supremácia dos Fatores Sistemáticos na B3
* **Data no Buffer:** 19/09/2026 às 15:00 UTC (12:00 BRT)
* **Buffer Post ID:** `6aa5c31deba7bc5677856c91`
* **Status:** `scheduled`

```text
A maioria dos investidores na bolsa brasileira passa horas tentando adivinhar qual será a próxima "ação da vez".
...
👉 https://analise-quantitativa.netlify.app
...
## Post 2: O Fator Momentum na B3: Cross-Sectional vs. Time-Series (Trend Following)
* **Data no Buffer:** 20/09/2026 às 15:00 UTC (12:00 BRT)
* **Buffer Post ID:** `6aa5c31ef7b1958d5cd67540`
* **Status:** `scheduled`
...
## Post 3: O "Factor Zoo" e a Armadilha da Mineração de Dados na Bolsa Brasileira
* **Data no Buffer:** 21/09/2026 às 15:00 UTC (12:00 BRT)
* **Buffer Post ID:** `6aa5c31f66679b076f181809`
* **Status:** `scheduled`
...
## Post 4: Backtesting Realista na B3: O Triângulo das Bermudas da Modelagem Quant
* **Data no Buffer:** 22/09/2026 às 15:00 UTC (12:00 BRT)
* **Buffer Post ID:** `6aa5c32066679b076f181831`
* **Status:** `scheduled`
...
## Post 5: Além de Markowitz: Por Que Gestoras Quants Usam Ledoit-Wolf e HRP na B3
* **Data no Buffer:** 23/09/2026 às 15:00 UTC (12:00 BRT)
* **Buffer Post ID:** `6aa5c32d7da3ee968d04ec51`
